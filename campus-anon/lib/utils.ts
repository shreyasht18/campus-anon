...
export const FLAIRS = [
  ...
  { name: "Tea ☕ Gossip", style: "bg-rose-500/10 text-rose-400 ring-rose-500/30 font-bold" },
  { name: "Hostel Life", style: "bg-yellow-500/10 text-yellow-400 ring-yellow-500/20" },
  { name: "Lost & Found", style: "bg-slate-500/10 text-slate-300 ring-slate-500/20" },
